      ...
      <div
        ...
        {logo && (
          <motion.div
            ...
            animate={hideText ? { opacity: 0, filter: "blur(8px)" } : { opacity: 1, filter: "blur(0px)" }}
            transition={{ duration: hideText ? 0.4 : 0.6, ease: [0.65, 0, 0.35, 1] }}
          >
            {logo}
          </motion.div>
        )}
        <div className="flex flex-wrap justify-center gap-x-3 px-8">
          {words.map((word, index) => (
            <motion.span
              ...
              transition={{
                duration: hideText ? 0.4 : 0.6,
                delay: hideText ? 0 : index * 0.1,
                ease: [0.65, 0, 0.35, 1],
              }}
              className={cn("text-4xl font-bold text-background dark:text-foreground", textClassName)}>
              {word}
            </motion.span>
          ))}
        </div>
    ...
    return (
      <div
        ...
        <motion.div
          ...
          className={cn("rounded-full aspect-square", bgColor ? "" : "bg-black dark:bg-[#5227FF]")}
          style={{
            width: "300vmax",
            height: "300vmax",
            backgroundColor: bgColor,
