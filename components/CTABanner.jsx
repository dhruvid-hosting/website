...
export default function Cta6() {
  return (
    <section
      className="w-full min-h-screen flex items-center justify-center py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950 overflow-hidden">
      <div className="relative max-w-[1400px] mx-auto w-full">
        ...
        <motion.div
          ...
          <h2
            className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-neutral-900 dark:text-white tracking-tight leading-tight max-w-[22ch]">
