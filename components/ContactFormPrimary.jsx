  ...
  return (
    <section className="w-full bg-white py-12 dark:bg-neutral-950 sm:py-24">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="mx-auto flex max-w-3xl flex-col gap-6 sm:flex-row sm:items-start sm:justify-center">
            ...
            <motion.a
              ...
              <div className="flex items-center justify-center mt-6 mb-6 sm:mt-0 sm:flex-1">
                <div className="relative">
                  {/* Background shape */}
                  <div
                    className="absolute inset-0 -m-6 rounded-4xl bg-indigo-100 opacity-60 dark:bg-indigo-950/40" />
                  <div
                    className="absolute inset-0 -m-3 rounded-3xl bg-indigo-200 opacity-70 dark:bg-indigo-900/50" />

                  {/* Icon container */}
                  <div
                    className="relative flex h-20 w-20 items-center justify-center rounded-xl bg-indigo-600 transition-transform group-hover:scale-110 dark:bg-indigo-500">
                    <method.icon className="h-10 w-10 text-neutral-300" strokeWidth={0.5} />
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <h3
                  className="text-base font-normal tracking-tight text-neutral-900 dark:text-neutral-50">
                  {method.title}
                </h3>
              </div>
            </motion.a>
