...
export default function Contact7() {
  return (
    <section
      className="w-full min-h-screen flex items-start py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
      <div
        className="max-w-xl mx-auto w-full flex flex-col items-center text-center">
        <motion.h2
        ...
        <motion.form
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <select
                className="w-full appearance-none px-3.5 py-2.5 pr-10 rounded-md bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-sm text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-neutral-900 dark:focus:ring-white cursor-pointer">
